    ...
    <div className="min-h-screen bg-background py-12">
      <div className="container mx-auto px-4 max-w-[800px]">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black text-text-main tracking-tight mb-4">Đặt hàng thành công!</h1>
          <p className="text-text-muted">Cảm ơn bạn đã đặt hàng. Vui lòng hoàn tất thanh toán.</p>
        </div>

        <div className="bg-surface border border-border rounded-3xl p-8 space-y-6">
          {/* Order Summary */}
          <div>
            <h2 className="text-xl font-bold text-text-main mb-4">Thông tin đơn hàng</h2>
          ...
          {/* Payment Options */}
          <div>
            <h3 className="text-lg font-bold text-text-main mb-4">Chọn phương thức thanh toán</h3>
            <div className="space-y-3">
              <button className="w-full p-4 border border-primary bg-primary/5 rounded-xl text-left hover:bg-primary/10 transition-all">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-text-main">Ví VNPay</p>
                    <p className="text-sm text-text-muted">Thanh toán nhanh qua ứng dụng VNPay</p>
                  </div>
                </div>
              </button>
              ...
              <button className="w-full p-4 border border-border bg-background rounded-xl text-left hover:border-primary transition-all">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-text-main">Thẻ ATM/Visa/Master</p>
                    <p className="text-sm text-text-muted">Thanh toán qua cổng VNPay</p>
                  </div>
                </div>
              </button>
            </div>
