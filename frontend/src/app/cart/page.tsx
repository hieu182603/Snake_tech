...
const CartPage: React.FC = () => {
  ...
  if (items.length === 0) {
    return (
      <div className="container mx-auto px-4 py-32 text-center">
        ...
        <p className="text-slate-400 mb-8 max-w-md mx-auto">Bạn chưa có sản phẩm nào trong giỏ hàng</p>
        <Link href="/catalog">
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-[1440px]">
      <div className="mb-10">
        <h1 className="text-3xl md:text-4xl font-black text-white tracking-tight">Giỏ hàng</h1>
